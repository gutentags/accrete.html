...
Main.prototype.addRandomTile = function (value) {
...
Main.prototype.takeRandomFreeSpace = function takeRandomFreeSpace() {
...
Main.prototype.addTile = function (position, value) {
    var tile = new Tile();
    tile.parent = this;
...
var last = new Point2();
var point = new Point2();
Main.prototype.swipe = function (major, minor, start, step) {
...
Main.prototype.swipeUp = function swipeUp() {
    this.swipe('x', 'y', 0, 1);
};

Main.prototype.swipeLeft = function swipeUp() {
    this.swipe('y', 'x', 0, 1);
};

Main.prototype.swipeDown = function swipeUp() {
    this.swipe('x', 'y', this.dimensions.y - 1, -1);
};

Main.prototype.swipeRight = function swipeUp() {
    this.swipe('y', 'x', this.dimensions.x - 1, -1);
};

Main.prototype.move = function (tile, destination) {
